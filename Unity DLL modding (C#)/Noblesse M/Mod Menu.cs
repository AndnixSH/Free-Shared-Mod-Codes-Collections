...
public class noblesseM : MonoBehaviour
{
    /// fields
    ...
    public static void ModMenuGUI()
    {
        ...
        // GUI.Label(new Rect(rect.x + 50f, rect.y + 130f + 45 * mulY, widthSize + 10, 50f), "<color=yellow>Note: This mod may not work for longer time\nDO NOT ABUSE THE MOD. ONLY USE MOD\nIF THE GAMEPLAY IS TOO HARD</color>", LabelStyle);
        ...
        /// Clicker Button
        // Open URL
        if (GUI.Button(BtnRect(3, false), "Visit platinmods.com", BtnStyle))
        {
