...
public class HOTD : MonoBehaviour
{
    ...
    public static void ModMenuGUI()
    {
		...
		GUI.Box(new Rect(rect.x, rect.y + 125f + (float)(45 * mulY), widthSize + 100f, 50f), "", BgStyle);
		GUI.Label(new Rect(rect.x + 50f, rect.y + 130f + (float)(45 * mulY), widthSize + 10f, 50f), "<color=yellow>Note: Attack multiplier decrease/increase by 50\nin order to complete level with very low power</color>", HOTD.LabelStyle);
        ...
        // }
        if (GUI.Button(BtnRect(1, true), "DMG multiplier: " + dmgMulti.ToString(), BtnStyle))
        {

        }
        if (GUI.Button(new Rect(rect.x + widthSize - 30, rect.y + btnY, 40, 40), "-", OffStyle))
        {
            if (dmgMulti > 1 && dmgMulti <= 30000)
                dmgMulti -= 50;
        }
        ...
        if (toggle3)
        {
            if (GUI.Button(BtnRect(4, false), "Very high critical attack: ON", OnStyle))
            {
                toggle3 = false;
            }
        }
        else if (GUI.Button(BtnRect(4, false), "Very high critical attack: OFF", OffStyle))
        {
            toggle3 = true;
        }
		...
		if (toggle4)
        {
            if (GUI.Button(BtnRect(5, false), "No mana cost: ON", OnStyle))
            {
                toggle4 = false;
            }
        }
        else if (GUI.Button(BtnRect(5, false), "No mana cost: OFF", OffStyle))
        {
            toggle4 = true;
        }
