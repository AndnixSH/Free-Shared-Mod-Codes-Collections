...
public class WK : MonoBehaviour {
    ...
    public static Rect rect = new Rect(40f, 40f, 110f, 110f);
    ...
    public static void ModMenuGUI()
    {
        ...
        if (toggle1)
        {
            if (GUI.Button(BtnRect(1, false), "Very high damage: ON", OnStyle))
            {
                toggle1 = false;
            }
        }
        else if (GUI.Button(BtnRect(1, false), "Very high damage: OFF", OffStyle))
        {
            toggle1 = true;
        }
        ...
        if (toggle2)
        {
            if (GUI.Button(BtnRect(2, false), "Very high HP: ON", OnStyle))
            {
                toggle2 = false;
            }
        }
        else if (GUI.Button(BtnRect(2, false), "Very high HP: OFF", OffStyle))
        {
            toggle2 = true;
        }

        if (GUI.Button(BtnRect(3, false), "Add 10k gold", BtnStyle))
        {
        ...
        if (GUI.Button(BtnRect(4, false), "Add 200 gems", BtnStyle))
        {
        ...
        /// Clicker Button
        // Open URL
        if (GUI.Button(BtnRect(5, false), "Visit platinmods.com", BtnStyle))
        {
    ...
    public static void Logo(int windowID)
    {
        ...
        if (Image == null)
        {
            ...
            /* D:\Pictures\Icons\Unity\pmt-min.png (30-10-2018 15:04:34)
   StartOffset(h): 00000000, EndOffset(h): 00002012, Length(h): 00002013 */
    ...
    0x42, 0x60, 0x82
        ...
        GUI.DrawTexture(new Rect(0f, 0f, 110f, 110f), Image);
