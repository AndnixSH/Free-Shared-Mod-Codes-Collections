//Game: Epic Fantasy: Great War 二次元战姬_二次元战姬公益服_变态版二次元战姬无限元宝服_二次元战姬官网_3733手机游戏
//Version: 1.0.0
//APK: ?
...
//BattleCalculator
		...
		{
			new AndroidJavaClass("net.thdl.THAdsManager").CallStatic("b", new object[]
			{
				"reward"
			});
			float num;
			if (ModMenu.hack1) // GOD MODE
			{
				...
				Tuple<int, float> atkAndDef = PSingleton<BattleCalculator.AtkAndDefFormula>.Instance.GetAtkAndDef(cfg.m_SkillType, attackerForce, attackType, targetForce, targetType);
				int p = atkAndDef.p1;
