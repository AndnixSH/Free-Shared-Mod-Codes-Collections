//Don't know what's going on here. This source was abandoned
...
void *hack_thread(void *) {
	...
	//Assembly-CSharp.dll
	//DHUnitEntity - get_MagicalDamage
    Hook([Your offset here], (void*)get_MagicalDamage, (void**) &orig_get_MagicalDamage);
	
	//DHUnitEntity - get_PhysicalDamage
    Hook([Your offset here], (void*)get_PhysicalDamage, (void**) &orig_get_PhysicalDamage);
	
	get_IsMyTeam = (bool(*)(void *))[Your offset here];
