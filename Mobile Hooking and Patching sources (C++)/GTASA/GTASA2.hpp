...
void GTASAHook() {
	...
	//DobbyHook(((void*)MSFindSymbol(NULL, "_ZN6CCheat12SuicideCheatEv")),(void *)Update,(void **)&orig_Update);
	//DobbyHook((void *)getRealOffset(0x4D73A8), (void *)Update, (void **) &orig_Update);
	...
	DobbyHook(HookLaRiotsActiveHere, (void *)LaRiotsActiveHere, (void **)&orig_LaRiotsActiveHere);
}
